...
public interface Fixtures {
  ...
  public final static String CAMPAIGN_JSON = "{\n" + 
  "            \"id\": 1234,\n" + 
  "            \"state\": \"active\",\n" + 
  "            \"advertiser_id\": 57440,\n" + 
  "            \"name\": \"test\",\n" + 
  ...
  public final static String CAMPAIGNS_RESPONSE = "{\n" + 
  		"   \"response\":{\n" + 
  		"      \"status\":\"OK\",\n" + 
  		"      \"campaigns\":[\n" + CAMPAIGN_JSON + 
  		"      ]\n" + 
  ...
  public final static List<Campaign> CAMPAIGNS = Lists.newArrayList(CAMPAIGN);
